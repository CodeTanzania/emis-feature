...
FeatureSchema.methods.preValidate = function preValidate(done) {
  ...
  let tags = [
    this.category, this.type, this.level,
    this.name, this.nickname, this.about,
  ...
  // 5. set tags
  this.tags = _.uniq(_.compact([].concat(...this.tags).concat(tags)));
