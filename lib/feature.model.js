...
const CATEGORIES = sortedUniq(getStrings('FEATURE_CATEGORIES', [
  ...
  async.waterfall([
    ...
    function findExistingFeature(next) {
      ...
      criteria = (
        criteria._id ?
        _.pick(criteria, '_id') :
        _.pick(criteria, 'category', 'type', 'level', 'name')
      );
