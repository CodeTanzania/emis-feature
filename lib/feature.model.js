...
const extractKeyword = require('keyword-extractor');
...
FeatureSchema.methods.preValidate = function preValidate(done) {
  ...
  // TODO tokenize and extract keywords
  // 4. set tags
  tags = _.uniq(_.compact([...this.tags].concat(tags)));
  tags = extractKeyword(tags.join(' '));
